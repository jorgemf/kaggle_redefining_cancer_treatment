...
USE_LAST_WORKER_FOR_VALIDATION = True  # whether or not to use the last worker for validation in distributed training
...
TC_LEARNING_RATE_DECAY = 0.85  # decay of learning rate

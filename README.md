...
```bash 
tport create job --name "kaggle-personalized-medicine-1" --project "jorgemf/kaggle-personalized-medicine-redefining-cancer-treatment-by-deep-learning" --datasets "jorgemf/kaggle-redefining-cancere-treatment"  --module "word2vec_train" --package-path "src" --python-version 2 --tf-version "1.2" --requirements "requirements.txt" --single-node --instance-type "t2.small" --time-limit "07h00m"
```